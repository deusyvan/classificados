...
?>
<div class="container">
	<h1>Meus Anúncios - Editar Anúncio: <?php echo $anuncio['titulo']?></h1>
	<form method="POST" enctype="multipart/form-data">
		<div class="form-group">
			...
			<select name="categoria" id="categoria" class="form-control">
				...
				<option value="<?php echo $cat['id'];?>" 
				    <?php echo ($anuncio['id_categoria'] == $cat['id'])?'selected="selected"': '';?>
		...
		<div class="form-group">
			...
			<input type="text" name="valor" id="valor" class="form-control" value="<?php echo $anuncio['valor'];?>"/>
		</div>
		<div class="form-group">
				...
				<div class="panel-body">
					<?php foreach ($anuncio['fotos'] as $foto):?>
						<div class="foto_item">
							...
							<a href="excluir-foto.php?id=<?php echo $anuncio['id']; ?>" class="btn btn-default">Excluir Imagem</a>
						</div>
					<?php endforeach;?>
				</div>
			</div>
